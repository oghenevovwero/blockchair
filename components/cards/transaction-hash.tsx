...
const TransactionHash: React.FC<TransactionHashProps> = () => {
  return (
    <div className="rounded-lg border border-white flex flex-col shadow-lg shadow-[#B0BDC7]">
      <div className="flex flex-col p-5 bg-[#FFFFFF] gap-2 rounded-t-lg">
      ...
      <div className="flex flex-col bg-[#EFF2F9] rounded-b-lg">
        ...
        <div className="flex flex-col p-5  gap-2 text-[#B0BDC7] text-sm font-[400]">
