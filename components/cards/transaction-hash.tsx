...
const TransactionHash: React.FC<TransactionHashProps> = () => {
  return (
    <div className="rounded-lg flex flex-col border-gray-800 border">
      <div className="flex flex-col p-5  bg-[#131313] rounded-t-lg gap-2">
        <span className="font-[100] text-sm opacity-50">Transaction hash</span>
      ...
      <div className="flex flex-col">
        <div className="flex flex-col p-5  gap-2">
          <div className="flex gap-1">
            <span className="font-[100] text-sm opacity-50">Amount transacted</span>
            <Image src="/qmark.svg" height={20} width={20} alt="copy" />
          </div>
          <span className="text-white">0.00511252BTC224.99USD</span>
        </div>
        <div className="flex flex-col p-5  gap-2">
          <div className="flex gap-1">
            <span className="font-[100] text-sm opacity-50">Amount transacted</span>
